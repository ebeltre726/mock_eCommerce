...
resource "aws_cloudfront_response_headers_policy" "security_headers" {
  ...
  security_headers_config {
    content_security_policy {
      ...
      content_security_policy = "default-src 'self'; script-src 'self' https://js.stripe.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: blob: https://${var.products_bucket_domain} https://${var.avatars_bucket_domain}; connect-src 'self' https://api.stripe.com https://q.stripe.com https://m.stripe.com https://m.stripe.network https://cognito-idp.${var.aws_region}.amazonaws.com; frame-src https://js.stripe.com https://hooks.stripe.com; form-action 'self'; object-src 'none'; base-uri 'self'"
      override = true
    }
